...
window.QUESTIONS = {
  ...
  'princess-amalia': {
    situation: 'Princess Amalia (Q7) is jointly owned by Eneco and Mitsubishi. Quarterly cost reports go to both partners. Both want them in their own format.',
    question: 'Smart approach?',
    options: [
      { text: 'Ask both partners to standardise on one format',                                                              correct: false },
      { text: 'Maintain two separate Excel reports',                                                                         correct: false },
      { text: 'Single source of truth in the ERP + a small export script that produces both partner formats automatically',  correct: true  },
      { text: 'Print and hand them over',                                                                                    correct: false },
    ],
    explanation: 'Two views, one source. Whenever data has to live in two places, the answer is one source of truth with multiple outputs — never two sources you keep in sync by hand.',
  },
  'borssele': {
  ...
  'lincolnshire': {
    situation: 'For this rolling project you write a long quarterly report for the Environment Agency. Same format, different numbers. It eats a full day every quarter.',
    question: 'What is the smartest route?',
    options: [
      { text: 'Ask if it can be done in Dutch',                                                                 correct: false },
      { text: 'Agree a fixed format with the client',                                                           correct: false },
      { text: 'Let AI draft the report from the numbers and your notes — you review and send',                 correct: true  },
      { text: 'Use the previous reports as the basis',                                                          correct: false },
    ],
    explanation: 'A day of writing versus an hour of reviewing. The report does not need to be written by you — it needs to be approved by you. Those are different jobs.',
  },
  'millport': {
  ...
  'kriegers-flak': {
    situation: 'The Danish client wants cost reports in a specific format that is different from what your ERP outputs. Someone transcribes the numbers into the client template manually every month.',
    question: 'Smartest solution?',
    options: [
      { text: 'Convince the Danish client to accept your format',                                                correct: false },
      { text: 'Build a conversion script that turns the ERP export into the client template automatically',     correct: true  },
      { text: 'Customise the ERP export',                                                                       correct: false },
      { text: 'Train a junior to do this task',                                                                  correct: false },
    ],
    explanation: 'External clients do not adapt to you. That is a given. The smart move: embrace their requirement and automate the translation — once.',
  },
  'baltica-2': {
